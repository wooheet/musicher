...
<%
	...
	WebMessageDTO responseDTO = nicepayWEB.doService(
			httpRequestWrapper, response);
...
<link rel="stylesheet" type="text/css"
	href="/Musicher/resources/nice_css/import.css" />
</head>
<script>
	function payResultclose(){
		//document.getElementById("uploadform").submit();
		opener.opener.parent.location.href="/Musicher/index.do"
		opener.parent.close();
		this.close();
	}
</script>
<body onunload="payResultclose()">
	<div class="payfin_area">
		...
		<div class="conwrap">
			...
			<div class="btngroup">
          		<a class="btn_blue" onClick="payResultclose();">확인</a>
        	</div>
		</div>
	</div>
</body>
